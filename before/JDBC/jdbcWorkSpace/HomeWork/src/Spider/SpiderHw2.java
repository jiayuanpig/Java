...
public class SpiderHw2 {
	...
	// JDBC driver name and database URL
	 ...
	 static final String DB_URL = "jdbc:mysql://localhost:3306/homework?characterEncoding=UTF-8";
